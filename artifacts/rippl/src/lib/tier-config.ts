...
export const TIER_CONFIG: TierDisplay[] = [
  { name: 'starter',       label: 'Influencer', icon: '/assets/tiers/influencer.svg', minReferrals: 0,  nextTierAt: 3,    nextTierLabel: 'Amplifier',  color: 'text-orange-400', bg: 'bg-orange-400/10', border: 'border-orange-400/20', progressBg: 'bg-orange-400/60' },
